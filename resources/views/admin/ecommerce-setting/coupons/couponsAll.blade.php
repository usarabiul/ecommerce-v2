...
<div class="page-breadcrumb d-flex align-items-center mb-3">
    <div class="breadcrumb-title pe-3">Coupons List</div>
    <div class="ms-auto">
        <div class="btn-group">
            ...
            <div class="dropdown-menu dropdown-menu-right dropdown-menu-lg-end">
                <a class="dropdown-item" href="{{route('admin.ecommerceCouponsAction','create')}}" ><i class="bx bx-plus"></i> Add Client </a>
                <a class="dropdown-item" href="{{route('admin.ecommerceCoupons')}}"><i class="bx bx-refresh"></i> Reload</a>
            </div>
        </div>
    </div>
</div>
