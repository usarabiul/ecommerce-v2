...
@section('title')
<title>{{websiteTitle('Tag Edit')}}</title>
@endsection
...
<div class="content-header row">
    ...
    <div class="content-header-right col-md-6 col-12 mb-md-0 mb-2">
        <div class="btn-group float-md-right" role="group" aria-label="Button group with nested dropdown">
            <a class="btn btn-outline-primary" href="{{route('admin.productsTags')}}">BACK</a>
...
<div class="content-body">
    ...
    <section class="basic-elements">
        ...
        <form action="{{route('admin.productsTagsAction',['update',$tag->id])}}" method="post" enctype="multipart/form-data">
            @csrf
            <div class="row">
                <div class="col-md-6">
                    <div class="card">
                        ...
                        <div class="card-content">
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="description" class="form-control {{$errors->has('description')?'error':''}}" placeholder="Write Description">{!!$tag->description!!}</textarea>
